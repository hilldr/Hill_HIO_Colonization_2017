...
gridExtra::grid.arrange(figure3b, figure3a, figure3c, figure3d, figure3e, layout_matrix = layout)
dev.off()

## EPS output
ggsave(filename = "../figures/figure3/eps/figure3_multipanel.eps", 
       plot = gridExtra::grid.arrange(figure3b, figure3a, figure3c, figure3d, figure3e, layout_matrix = layout), 
       width = 20, height = 20)
