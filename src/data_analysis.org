...
FILES=../data/figure5_/dapi_ki67_edu_counts/*
echo "count  file" > ../data/figure5_/cell_counts.tsv
for f in $FILES
do
    wc -l $f >> ../data/figure5_/cell_counts.tsv
done	 
#+end_src
...
**** Data import and manipulation 
#+begin_src R :session *R* :results silent :exports none :eval yes :tangle figure_Rscripts/figure5_.R
## FIGURE 4_ --------------------------------------------------------------------
## Figure 4A_: EdU and Ki67 count data
## execute counting script
system("./figure5_count.sh")
## import data
counts <- readr::read_delim(file = "../data/figure5_/cell_counts.tsv", delim = "\t",
                            col_names = FALSE, skip = 1)

## separate count data from file name
library(magrittr) # enables pipe operation ('%>%')
counts$count <- stringr::str_split_fixed(string = counts$X1, pattern = " ../data/figure5_/d", n = 2)[,1] %>% as.numeric()
counts$file <- stringr::str_split_fixed(string = counts$X1, pattern = " ../data/figure5_/d", n = 2)[,2]
...
**** Generate plot
#+begin_src R :session *R* :exports none :results graphics :file ../figures/figure5_/figure5a_.png :eval yes :tangle figure_Rscripts/figure5_.R
library(ggplot2)
source("ggplot2-themes.R")
library(magrittr)
...
figure5a_ <- ggplot(data = data.sum, aes(x = hr, y = mean)) +
...
png(filename = "../figures/figure5_/figure5a_.png", width = 800, height = 800)
print(figure5a_)
dev.off()
ggsave(filename = "../figures/figure5_/eps/figure5a_.eps", 
plot = figure5a_, 
width = 16, height = 16)
#+end_src
...
**** Generate plot
#+begin_src R :session *R* :exports none :results graphics :file ../figures/figure5_/figure5e_.png :eval yes :tangle figure_Rscripts/figure5_.R
## plot
library(ggplot2)
source("ggplot2-themes.R")
...
png(filename = "../figures/figure5_/figure5e_.png", width = 500, height = 1000)
print(figure5e_)
dev.off()
ggsave(filename = "../figures/figure5_/eps/figure5e_.eps", 
plot = figure5e_, 
width = 16, height = 16)
#+end_src
...
#+begin_src R :session *R* :exports none :results graphics :file ../figures/figure5_/figure5_multipanel.png  :width 1600 :height 1600 :eval yes :tangle figure_Rscripts/figure5_.R
## Figure 6 multipanel ---------------------------------------------------------
source("ggplot2-themes.R")
source("custom_fun.R")
library(ggplot2)
...
## EdU staining
figure5b_ <- png2ggplot("../data/figure5_/EdU_figure_cropped.png") +
    img.theme + coord_fixed(ratio = 1/1.5) + ggtitle("A")

## Sox9 staining
figure5c_ <- png2ggplot("../data/figure5_/sox9_figure.png") +
    img.theme + coord_fixed(ratio = 1/1.5) + ggtitle("C")

## dppIV staining
figure5d_ <- png2ggplot("../data/figure5_/dppiv_figure.png") +
...
## PDF output
pdf(file = "../figures/figure5_/figure5_multipanel.pdf", width = 8000/300, height = 8250/300, onefile = FALSE)
gridExtra::grid.arrange(figure5b_, figure5a_, figure5c_, figure5d_, figure5e_, layout_matrix = layout)
dev.off()

## EPS output
ggsave(filename = "../figures/figure5_/eps/figure5_multipanel.eps", 
       plot = gridExtra::grid.arrange(figure5b_, figure5a_, figure5c_, figure5d_, figure5e_, layout_matrix = layout), 
       width = 20, height = 20)

## PNG output
png(filename = "../figures/figure5_/figure5_multipanel.png", width = 1865, height = 2000)
gridExtra::grid.arrange(figure5b_, figure5a_, figure5c_, figure5d_, figure5e_, layout_matrix = layout)
dev.off()
#+end_src

#+RESULTS:
[[file:../figures/figure5_/figure5_multipanel.png]]
